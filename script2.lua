...
if MN == 3 then wallsnapdrangonall() end
...
if exmenu == 7 then exynos7420() end
...
gg.setValues({[1]={address = tt[1].address -140,flags = 16,value = 999999}})
...
if digerhack == 2 then gorunmez() end
end
PUBGMH = -1
end
--Diğer Oyun Hileleri Menü
